...
# Material Icons Round subset (PORTING_NOTES §7, 33 glyphs)
# The last five are the WiFi signal ladder for the scan list. They are the
# `network_wifi*` family ON PURPOSE: it is one wedge that fills progressively,
# so the five read as one scale. The similarly-named `wifi_1_bar`/`wifi_2_bar`
# do NOT belong to it -- rendered, `wifi_1_bar` is a bare dot and plain `wifi`
# is the 3-arc radiating glyph, so mixing them looks like three unrelated
# icons. Verified by rasterising the font, not by reading the names.
MATERIAL='0xe145,0xe39e,0xe2ea,0xe3ab,0xe5ca,0xef4a,0xe5cd,0xe872,0xe5cf,0xe88a,0xe518,0xe0f0,0xe405,0xe034,0xe037,0xe1c4,0xe05f,0xe8ac,0xe03d,0xe836,0xe5d5,0xf053,0xe8b6,0xe043,0xe044,0xe047,0xe429,0xe63e,0xf0b0,0xebe4,0xebd6,0xebe1,0xe1ba'
